                  ...
                  <div class="row">
                    ...
                    <div class="tile_count">
                      <div class="col-md-4 col-sm-4  tile_stats_count">
                        <span class="count_top"><i class="fa fa-medkit"></i> Number Patient</span>
                        <div class="count"><?php $data->Totalpatient(); ?></div>
                      </div>
                      <div class="col-md-4 col-sm-4  tile_stats_count">
                        <span class="count_top"><i class="fa fa-money "></i> Number Payment</span>
                        <div class="count"><?php $data->Totalpayment(); ?></div>
                      </div>
                      <div class="col-md-4 col-sm-4  tile_stats_count">
                        <span class="count_top"><i class="fa fa-user"></i> Number Users</span>
                        <div class="count"><?php $data->TotalUsers();?></div>
                      </div>
                    </div>
                  </center>
</div>
