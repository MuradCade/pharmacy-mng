              ...
              <div class="col-md-12 col-sm-12  ">
                <div class="x_panel">
                  ...
                  <div class="alert alert-danger text-center text-dark" role="alert" style='font-size:14px; font-weight:bold;'>
                    ...
                    <?php }?>
                  <form action="reception-class/add-patientinfo.php"  method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype='multipart/form-data'>
